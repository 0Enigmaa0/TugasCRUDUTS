    ...
    <div class="container mt-5">
        ...
        <div class="table-container">
            <div class="table-responsive">
                <a href="datapeminjaman/tambah.php" class="btn btn-primary mb-3">
                    <i class="fas fa-user-plus"></i> Tambah Data Peminjaman
                </a>
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        include 'koneksi.php';
                        $no = 1;
                        $data = mysqli_query($koneksi, "select * from data_peminjaman");
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="datapeminjaman/ubah.php?ID_pinjam=<?php echo $d['ID_pinjam']; ?>" class="btn btn-sm btn-info">
                                    <i class="fas fa-edit"></i> Ubah
                                </a>
                                <a href="datapeminjaman/hapus.php?ID_pinjam=<?php echo $d['ID_pinjam']; ?>" class="btn btn-sm btn-danger">
