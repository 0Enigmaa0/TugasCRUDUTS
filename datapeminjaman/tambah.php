    ...
    <div class="form-container">
        ...
        <form method="post" action="inputuser.php">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="ID_pinjam" name="ID_pinjam" placeholder="Masukkan ID_pinjam" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="ID_staff" name="ID_staff" placeholder="Masukkan ID Staff" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control" id="tgl_kembali" name="tgl_kembali" placeholder="Masukkan tangal pengembalian" required>
            </div>
