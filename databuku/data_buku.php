        ...
        <div class="table-container">
            <div class="table-responsive">
                <a href="tambah.php" class="btn btn-primary mb-3">
                    <i class="fas fa-user-plus"></i> Tambah Data Buku
                </a>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="ubah.php?ID_buku=<?php echo $d['ID_buku']; ?>" class="btn btn-sm btn-info">
                                    <i class="fas fa-edit"></i> Ubah
                                </a>
                                <a href="hapus.php?ID_buku=<?php echo $d['ID_buku']; ?>" class="btn btn-sm btn-danger">
