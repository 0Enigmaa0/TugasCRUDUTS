    ...
    <div class="form-container">
        ...
        <form method="post" action="inputuser.php">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="ID_staff" name="ID_staff" placeholder="Masukkan ID_staff" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="No_telp" name="No_telp" placeholder="Masukkan No_telp" required>
            </div>
